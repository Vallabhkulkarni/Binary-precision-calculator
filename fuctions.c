...
list *addition(list *l1, list *l2) {
	...
	if(l1->sign != l2->sign) {
		if(l1->sign == -1) {
			l1->sign = 1;
			result = substraction(l2, l1);
		}
		else if(l2->sign == -1) {
			l2->sign = 1;
			result = substraction(l1, l2);
		}
	}
